...
namespace ifmo_user_aspnet_functests
{
    public class UnitTest1
    {
        ...
        public void CanEdit()
        {
            ...
            var element1_1 = driver.FindElement(By.Name("_login"));
            element1_1.SendKeys("testuser" + random);
            var element3 = driver.FindElement(By.Name("_fname"));
            element3.SendKeys("testedit" + random);
            var element2_2 = driver.FindElement(By.Name("_reg_submit"));
            element2_2.Click();

            var bodyTag = driver.FindElement(By.TagName("body"));
            if (bodyTag.Text.Contains("testedit" + random))
            {
                test_result = true;
            }
